<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="text-white hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.register.staff')" :active="request()->routeIs('admin.register.staff')">
                        {{ __('Register Staff') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div x-bind:class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('record_sales')" :active="request()->routeIs('record_sales')">
                {{ __('Record Sales') }}
